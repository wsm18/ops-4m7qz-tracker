...
window.QUIZ_BANK = {
  ...
  landnav: {
    ...
    questions: [
      ...
      {q:"A hill is a major terrain feature best described as:", a:["An area of low ground surrounded by higher ground","A point or small area of high ground; ground slopes down in all directions from its peak","A line of high ground with a continuous line of elevation","A depression cut by running water"], c:1, e:"Hill: ground slopes down in all directions from the peak (closed, concentric contours). (AS – Terrain Features)"},
      {q:"A saddle is a major terrain feature best described as:", a:["A low point between two areas of higher ground, on a ridgeline","A steep, vertical rock face","A man-made drainage cut","The nose of a ridge"], c:0, e:"Saddle: a dip or low point along a ridge between two areas of higher ground — often the highest point on a road/trail crossing a ridge. (AS – Terrain Features)"},
      {q:"A depression is a major terrain feature best described as:", a:["High ground with a continuous line of elevation","A point of high ground","A low point, or hole, in the ground with no natural drainage — contour lines with tick marks pointing inward","A finger of high ground extending from a ridge"], c:2, e:"Depression: a low area with no drainage; shown with hachure/tick marks pointing toward the low point. (AS – Terrain Features)"},
      {q:"A draw is a minor terrain feature best described as:", a:["A short, sharp inward cut on the side of a ridge","A fairly straight cut in the ground, similar to a valley but smaller, with only one direction of drainage","An extension of a ridge","A steep vertical drop"], c:1, e:"Draw: like a valley but tighter and steeper-sided, with the ground sloping upward on three sides — water drains along its bottom. (AS – Terrain Features)"},
      {q:"A spur is a minor terrain feature best described as:", a:["A short, continuous sloping line of higher ground, normally jutting out from the side of a ridge — a finger","A cut for a road or railroad through higher ground","A man-made stack of dirt","A vertical or near-vertical rock face"], c:0, e:"Spur: a short sloping extension off a ridge, with the ground sloping down in three directions and up in only one (back toward the ridge). (AS – Terrain Features)"},
      {q:"A cliff is a minor terrain feature best described as:", a:["A gentle, rolling slope","A vertical or near-vertical feature — shown on a map by contour lines very close together, sometimes merging into one 'carrot tooth' symbol","A man-made cut through a hill","A low point with no drainage"], c:1, e:"Cliff: a vertical or near-vertical drop, shown by contour lines packed together or a cliff (tick) symbol. (AS – Terrain Features)"},
      {q:"To determine your personal pace count, you:", a:["Estimate it based on your height","Walk a known, measured distance (e.g. 100m) and count the number of paces it takes, repeating for an average","Use the same fixed number as everyone else","Count your steps for one minute of walking"], c:1, e:"Pace count is individual — measured by walking a known distance (commonly 100m) multiple times and averaging the pace count, then adjusted for terrain/load/visibility. (AS – Land Navigation)"},
      {q:"Resection is the technique used to:", a:["Plot an unknown point by sighting azimuths to it from two known points","Determine your own unknown location by shooting azimuths to two or more known, identifiable distant points and plotting back-azimuths from them","Convert a magnetic azimuth to a grid azimuth","Measure distance using pace count"], c:1, e:"Resection: shoot azimuths to 2+ known points, plot the back-azimuth from each on the map — where the lines cross is your location. (AS – Land Navigation)"},
      {q:"Intersection is the technique used to:", a:["Determine your own location from known points","Locate an unknown point (e.g. a distant enemy position) by sighting and plotting azimuths to it from two different known locations","Find a back azimuth","Convert mils to degrees"], c:1, e:"Intersection: from two known locations, shoot an azimuth to the unknown point from each and plot; where the two lines cross is the unknown point's location. (AS – Land Navigation)"},
    ]
  },
  firstaid: {
  ...
  opords: {
    ...
    questions: [
      ...
      {q:"The third step of TLP is:", a:["Make a tentative plan","Conduct reconnaissance","Initiate movement","Issue the OPORD"], c:0, e:"Step 3: Make a tentative plan. (AS – TLP)"},
      {q:"The fourth step of TLP is:", a:["Complete the plan","Initiate movement","Conduct reconnaissance","Supervise and refine"], c:1, e:"Step 4: Initiate movement — necessary movement starts as soon as possible, in parallel with the rest of TLP, not after it. (AS – TLP)"},
      {q:"The fifth step of TLP is:", a:["Conduct reconnaissance","Complete the plan","Issue the OPORD","Make a tentative plan"], c:0, e:"Step 5: Conduct reconnaissance. (AS – TLP)"},
      {q:"The sixth step of TLP is:", a:["Issue the OPORD","Complete the plan","Supervise and refine","Initiate movement"], c:1, e:"Step 6: Complete the plan, incorporating what recon found. (AS – TLP)"},
      {q:"The seventh step of TLP is:", a:["Supervise and refine","Complete the plan","Issue the OPORD","Conduct reconnaissance"], c:2, e:"Step 7: Issue the OPORD. (AS – TLP)"},
      {q:"The eighth and final step of TLP is:", a:["Issue the OPORD","Supervise and refine","Complete the plan","Initiate movement"], c:1, e:"Step 8: Supervise and refine — includes rehearsals and pre-combat checks/inspections. (AS – TLP)"},
  ...
  cbrn: {
    name: "CBRN / NBC Defense",
    icon: "☢️",
    pass: 0.8,
    questions: [
      {q:"CBRN stands for:", a:["Chemical, Biological, Radiological, Nuclear","Combat, Battle, Reconnaissance, Navigation","Casualty, Bleeding, Rescue, Notification","Chemical, Basic, Recon, Nuclear"], c:0, e:"Chemical, Biological, Radiological, Nuclear — the four hazard categories CBRN defense addresses. (AS – CBRN Awareness)"},
      {q:"MOPP stands for:", a:["Mission Oriented Protective Posture","Military Operations Protection Plan","Mask On, Prepare, Proceed","Mobile Operations Protective Procedure"], c:0, e:"Mission Oriented Protective Posture — the graduated system of individual protective equipment worn based on the threat level. (AS – CBRN Awareness)"},
      {q:"MOPP levels range from MOPP 0 (ready, gear carried) up to the highest level of:", a:["MOPP 2","MOPP 3","MOPP 4","MOPP 5"], c:2, e:"MOPP 4 is full protection: overgarment, mask, gloves, and overboots all worn. (AS – CBRN Awareness)"},
      {q:"The four main categories of chemical agents are nerve, blister, blood, and:", a:["Choking (pulmonary)","Sedative","Incendiary","Riot control"], c:0, e:"Nerve, blister, blood, and choking/pulmonary agents are the four main chemical agent categories. (AS – CBRN Awareness)"},
      {q:"The current standard-issue Army protective mask is the:", a:["M40","M50 (Joint Service General Purpose Mask)","M17","ACH"], c:1, e:"The M50 JSGPM is the current fielded protective mask. (AS – CBRN Awareness)"},
      {q:"A full set of MOPP gear includes the protective overgarment, protective mask, protective gloves, and:", a:["Protective overboots","A gas-particulate filter canteen","An M8 detection paper kit","A decon kit only"], c:0, e:"Overgarment, mask, gloves, and overboots are the four components worn across MOPP 1–4. (AS – CBRN Awareness)"},
      {q:"Upon the first sign or warning of a chemical attack, a Soldier's immediate action is to:", a:["Move to the nearest bunker","Don the protective mask immediately, then continue MOPP as directed","Radio higher before doing anything else","Wait for the buddy team to react first"], c:1, e:"Mask first, immediately — seconds matter with a chemical agent. Report and continue protective measures after. (AS – CBRN Awareness)"},
      {q:"Immediate (individual) decontamination is performed:", a:["Within 1 minute of skin contamination, using a personal decon kit or improvised absorbent/wipe","Only after returning to a fixed base","24 hours after exposure","Only by dedicated decon teams, never by the individual"], c:0, e:"Immediate decon (e.g. the M291 skin decontamination kit) is done by the individual within about a minute of contamination — speed matters most for skin agents. (AS – CBRN Awareness)"},
    ]
  }
};
