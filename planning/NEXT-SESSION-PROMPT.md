...
**Current version: v206.** The service worker is at `operations-v206` in `sw.js`. `SKILL_LADDER_VER` is **118** (unchanged since v186 — v187 through v206 touched no ladder/tier/guidance content). Total skills: **12524**.
